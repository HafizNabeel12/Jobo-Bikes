...
const rangeSliderStyles = `
  ...
  .range-slider::-webkit-slider-track {
    height: 8px;
    background: linear-gradient(to right, #12b190 0%, #12b190 var(--value), #e5e7eb var(--value), #e5e7eb 100%);
    border-radius: 4px;
  }
    ...
    <>
      ...
      <div className="mb-8">
        ...
        <div className="w-full bg-gray-200 rounded-full h-2">
          <div 
            className="bg-[#12b190] h-2 rounded-full transition-all duration-300"
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="flex justify-between text-sm text-gray-700 mt-2">
              ...
              <span className="font-semibold text-[#12b190]">{formData.budget?.toLocaleString()} NOK</span>
        ...
        <div className="space-y-6">
                ...
                <button
                  ...
                  className={`px-4 py-3 rounded-lg border-2 transition-all ${
                    formData.usageType?.includes(type)
                      ? 'border-[#12b190] bg-[#12b190] text-white font-medium'
          ...
          <div>
            ...
            <select 
              ...
              className="w-full px-4 py-3 bg-white border border-gray-600 text-gray-700 rounded-lg focus:ring-2 focus:ring-[#12b190] focus:border-transparent"
            >
          ...
          <div>
            ...
            <div className="flex justify-between text-sm text-gray-700 mt-2">
              <span>20 km</span>
              <span className="font-semibold text-[#12b190]">{formData.rangeRequirement} km</span>
              <span>150 km</span>
            </div>
          </div>
        </div>
      ...
      <div className="flex justify-between mt-8 pt-6 border-t border-gray-300">
        {currentPage > 1 && (
          <button
            type="button"
            onClick={prevPage}
            className="sm:px-2 md:px-6 py-3 border-2 border-[#12b190] bg-[#12b190] rounded-lg font-medium text-white hover:bg-[#08866c] transition-colors"
          >
            ← Previous
          </button>
        )}
        ...
        {currentPage < totalPages ? (
          <button
            ...
            className="ml-auto px-6 py-3 bg-[#12b190] text-white rounded-lg font-medium hover:bg-[#088f74] transition-colors"
          >
            Next →
          </button>
        ) : (
          <button
            ...
            className="ml-auto sm:px-2 md:px-8 py-3 bg-[#12b190] text-white rounded-lg sm:font-medium hover:bg-[#087f67] transition-colors disabled:bg-gray-600 disabled:cursor-not-allowed"
          >
            Find My E-Bike 
          </button>
        )}
