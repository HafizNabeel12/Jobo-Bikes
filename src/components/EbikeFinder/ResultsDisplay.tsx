...
export default function ResultsDisplay({ 
  ...
  return (
    <div className="space-y-8 bg-white">
      ...
      {/* Top Recommendation */}
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden border-4 border-[#12b190]">
        <div className="bg-[#12b190] px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              <span className="inline-block bg-white text-[#12b190] px-3 py-1 rounded-full text-sm font-bold mb-2">
                BEST MATCH
              </span>
                ...
                <div className="text-3xl font-bold text-black mb-4">
                 ...
                 <div className="flex gap-3">
                  <Link 
                    ...
                    className="flex-1"
                  >
                    <button className="w-full bg-[#12b190] text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-700 transition-colors">
                      View Details
                    </button>
                  </Link>
