          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0 w-12 h-12 bg-[#58c0c2] rounded-lg flex items-center justify-center">
            ...
            <div className="relative">
              <div className="bg-gradient-to-r from-[#58c0c2] to-[#58c0c2] rounded-2xl p-8 text-black">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-sm border">
              <div className="flex mb-4">
                {[...Array(5)].map((_, i) => (
                  <span key={i} className="text-[#58c0c2]">★</span>
                ))}
              </div>
      ...
      <section className="hidden md:block py-16 bg-white ">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-[#58c0c2] rounded-full flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-16 bg-black text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-4xl text-[#58c0c2] mb-2">5000+</div>
              <div className="text-gray-300">Fornøyde kunder</div>
            </div>
            <div>
              <div className="text-4xl text-[#58c0c2] mb-2">opp til 60km</div>
              <div className="text-gray-300">Maks rekkevidde</div>
            </div>
            <div>
              <div className="text-4xl text-[#58c0c2] mb-2">2 år</div>
              <div className="text-gray-300">Garanti</div>
            </div>
            <div>
              <div className="text-4xl text-[#58c0c2] mb-2">24/7</div>
