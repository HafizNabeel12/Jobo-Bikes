...
const Hero = () => {
  ...
  <div className="absolute inset-0 z-30 hidden sm:flex flex-col justify-center px-6 lg:px-12 text-left">
    <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
      End of Summer Sale
      <span className="block text-[#58c0c2] text-xl md:text-2xl lg:text-3xl">
        Upto 30% OFF
      </span>
    </h1>

    <div className="flex flex-col sm:flex-row gap-4 justify-start">
      <button className="group bg-[#58c0c2] text-black font-bold px-7 md:px-8 py-3 md:py-4 rounded-full text-base md:text-lg hover:bg-[#58c0c2] transition-all duration-300 transform hover:scale-105 flex items-center gap-2 shadow-lg md:shadow-xl">
        Shop Now
  ...
  <div className="sm:hidden relative z-30 flex flex-col items-center text-center px-4 py-6">
    <h1 className="text-xl font-bold text-black mb-3 leading-snug">
      End of Summer Sale
      <span className="block text-[#58c0c2] text-base">Upto 30% OFF</span>
    </h1>

    <button className="group bg-[#58c0c2] text-black font-bold px-5 py-2.5 rounded-full text-sm hover:bg-[#58c0c2] transition-all duration-300 transform hover:scale-105 flex items-center gap-2 shadow-lg">
      Shop Now
      ...
      {/* <div className="absolute inset-0 z-1">
        <div className="absolute top-20 left-10 w-20 h-20 bg-[#58c0c2] rounded-full opacity-10 animate-pulse"></div>
        <div className="absolute top-40 right-20 w-16 h-16 bg-gray-400 rounded-full opacity-10 animate-bounce delay-75"></div>
        <div className="absolute bottom-32 left-20 w-12 h-12 bg-[#58c0c2] rounded-full opacity-10 animate-pulse delay-150"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        {/* <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16 mb-10 pt-16 border-t border-gray-700">
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-[#58c0c2] mb-2">50K+</div>
            <div className="text-gray-400 text-sm">Happy Students</div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-[#58c0c2] mb-2">30+</div>
            <div className="text-gray-400 text-sm">Miles Range</div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-[#58c0c2] mb-2">4.9★</div>
            <div className="text-gray-400 text-sm">Customer Rating</div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-[#58c0c2] mb-2">24/7</div>
      ...
      {/* <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
        <div className="animate-bounce">
          <div className="w-1 h-8 bg-[#58c0c2] rounded-full"></div>
        </div>
      </div> */}
    </section>
  );
